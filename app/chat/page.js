...
const initialMessages = [
  {
    id: 1,
    role: "ai",
    text: "Hi Jamal 👋 I'm your Floraflyers travel assistant. Tell me your destination, budget, or trip dates, and I'll build a personalized plan for you.",
        ...
        <main className="flex-1 flex flex-col min-w-0">
                    ...
                    {m.plan && (
                      <div className="mt-3 border border-gray-200 rounded-sm2 overflow-hidden">
                        {m.plan.map((p) => (
                          ...
                          >
                            <span className="font-mono text-xs font-bold text-teal-hover">
                              {p.day}
                            </span>
                            <span>{p.desc}</span>
                          </div>
                        ...
                        <div className="bg-lightbg px-3.5 py-2.5 flex justify-between items-center font-bold text-sm">
                          Estimated total{" "}
                          <span className="text-coral">{m.total}</span>
                        </div>
                      </div>
                    )}
                  </div>
          ...
          <div className="px-7 pt-4 pb-6 bg-lightbg border-t border-gray-200 flex-shrink-0">
            <div className="flex gap-2 mb-3 flex-wrap">
              {["🏖 Beach getaways", "💰 Under $500", "🗓 This weekend"].map(
                (s) => (
                  <button
                    key={s}
            ...
            <div className="text-center text-xs text-gray-400 mt-2.5">
              Floraflyers can make mistakes. Verify important trip details
              before booking.
            </div>
          </div>
        </main>
